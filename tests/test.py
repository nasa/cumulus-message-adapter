...
class Test(unittest.TestCase):
  ...
  def test_with_replace(self):
    ...
    """
    result = sled_message.createNextEvent(nestedResponse, event_with_replace, None)
  ...
  def test_small_result_returns_event(self):
    ...
    result = sled_message.createNextEvent(nestedResponse, event_without_replace, None)
    expected_result = {
      'input': ':baby_whale:',
      'exception': 'None',
      'payload': {
  ...
  def test_big_result_stored_remotely(self, uuid_mock):
    ...
    createNextEvent_result = sled_message.createNextEvent(nestedResponse, event_with_ingest, None)
