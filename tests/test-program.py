...
class Test(unittest.TestCase):
    ...
    @staticmethod
    def read_streaming_output(stream_process: subprocess.Popen[bytes]) -> CumulusMessage:
        """
    ...
    def transform_messages_streaming(
        self,
